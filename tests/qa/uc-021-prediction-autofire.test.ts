 ...
 *
 * Automatable: yes — the auto-fire path is tested in plugin.test.ts
 * (prediction nudge via chat.message, independent firing, no-match
 * suppression). The end-to-end "agent acts on prediction" flow is manual.
 */
