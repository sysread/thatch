 ...
 *
 * Automatable: yes — prediction_delete is tested in tool-defs.test.ts (found
 * and not-found cases), and deletePrediction cascade is tested in
 * prediction.test.ts (cascade to edges and provenance, non-existent ID).
 */
