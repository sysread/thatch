 ...
 *
 * Automatable: yes — the create-on-existing path is tested in
 * tool-defs.test.ts (prediction_update create on existing prediction links
 * without disconfirming). The dedup + edge + confidence behavior is verified
 * with assertions on the return value and prediction_list output.
 */
