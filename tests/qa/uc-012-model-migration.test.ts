 ...
 *
 * Automatable: yes — dimension-skip and data-intact assertions are pure DB calls; use two
 * `MockEmbeddingModel` instances with different dimensions (no network, no real model download).
 */
