 ...
 * SHARED_SKILLS only (27 skills, no coordinator).
 */
...
const useCase: UseCase = {
  ...
  expected: [
    "- Claude Code: 27 thatch-* skill directories present. thatch-code-review is absent.",
    "- Cursor: 27 thatch-* skill directories present. thatch-code-review is absent.",
    "- opencode: 28 thatch-* skill directories present. thatch-code-review is present (verified by uc-014).",
  ].join("\n"),
