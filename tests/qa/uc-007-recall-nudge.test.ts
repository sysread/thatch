 ...
 *
 * Automatable: partial — the sideband embed + search round-trip and threshold
 * logic are unit-tested in `sideband.test.ts`; a live agent observing and
 * acting on the nudge is manual.
 */
