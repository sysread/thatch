 ...
 *
 * Automatable: yes — `flush-tools` is a deterministic CLI contract and sideband failure modes
 * (server down, stale socket, timeout) plus tier ordering are filesystem/IPC only, with no LLM
 * in the loop.
 */
