 ...
 *
 * Automatable: yes — the confidence math and signal mapping are tested in
 * prediction.test.ts (adjustConfidence confirm/disconfirm/soft/multiple) and
 * tool-defs.test.ts (prediction_update confirm applies signal immediately).
 */
