...
const useCase: UseCase = {
  ...
  expected: [
    ...
    "  repeats each turn with escalated tone (and the queued interactions grow if",
    "  new tool activity adds entries between nudges). The nudge carries the session",
    "  ID and fetch tool name, not the full payload — the sub-agent fetches it via",
