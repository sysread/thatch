 ...
 *
 * Automatable: yes — `setup.test.ts` already covers the unit contract (10 tests
 * in the `checkSetup` describe block: null, local, global, not-installed,
 * markers-broken, local priority, Cursor variants, Cursor priority). This is
 * the end-to-end runbook version. Requires a live opencode session.
 */
